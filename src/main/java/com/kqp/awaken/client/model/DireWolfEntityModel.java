...
/**
 * Model for the dire wolf.
 * Basically just the vanilla wolf.
 */
@Environment(EnvType.CLIENT)
public class DireWolfEntityModel<T extends DireWolfEntity> extends TintableAnimalModel<T> {

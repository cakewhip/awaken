...
public class VoidGhostEntity extends HostileEntity {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(5, floatGoal = new FloatAroundGoal(this));
    ...
    public void tickMovement() {
        ...
        } else if (floatGoal != null && floatGoal.target != null) {
            targetPos = new Vec3d(floatGoal.target.getX(), floatGoal.target.getY(), floatGoal.target.getZ());

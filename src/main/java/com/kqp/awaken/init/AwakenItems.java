...
public class AwakenItems {
    ...
    public static final Item SALVERIUM_PICKAXE = register("salverium_pickaxe", new AwakenPickaxeItem(AwakenToolMaterial.tool(4, 2031, 9F, 6F, 1.2F, 15, SALVIUM_INGOT, VALERIUM_INGOT)));

package com.kqp.terminus.entity;
...
public class RaptorChickenEntity extends AnimalEntity {
    ...
    public RaptorChickenEntity(World world) {
        super(Terminus.TEntities.RAPTOR_CHICKEN, world);
    ...
    public void tickMovement() {
        ...
        if (!this.world.isClient && this.isAlive() && !this.isBaby() && --this.eggLayTime <= 0) {
            ...
            this.dropItem(Terminus.TItems.RAPTOR_CHICKEN_EGG);
            resetEggTimer();
        }
    }
    ...
    public PassiveEntity createChild(PassiveEntity mate) {
        return Terminus.TEntities.RAPTOR_CHICKEN.create(this.world);
    }
